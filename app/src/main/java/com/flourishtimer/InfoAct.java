...
public class InfoAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.flourishtimer.R.layout.activity_info);

        TextView pp = findViewById(com.flourishtimer.R.id.pp);
        pp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = "https://sites.google.com/view/flourishprivacypolicy/home";
